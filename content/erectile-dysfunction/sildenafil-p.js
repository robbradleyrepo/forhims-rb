...
export const sildenafilP = {
  componentType: "page",
  id: "sildenafil-p-treatment-page",
  props: {
    ...
    links: [
      {
        hrefLang: "en-gb",
        href: ROUTE_PATHS.pdpSexSildenafilP
      },
      {
        hrefLang: "en-us",
    ...
    sections: [
      ...
      },
      {
        ...
        props: {
          ...
          body:
            "Following an assessment of the safety of Sildenafil, the MHRA have decided to reclassify the drug to a pharmacy medication. That means you no longer need a prescription to buy Sildenafil.",
      ...
      // },
      {
        ...
        props: {
          ...
          products: [
            {
              id: PRODUCT_ID_BY_NAME.sildenafilp,
              title: "Sildenafil",
